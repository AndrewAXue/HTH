...
<div class="container">
    <div class="row">
        <div class="four columns" style="margin-top: 3%">
            ...
            <form method="GET" action="php/test.php">
                ...
                <div>
                    ...
                    ?> id="kval" name="k_val"
                           min="1" max="10"></div>
                Show Hospitals:  <input type="checkbox" name="showHospitals" id="showhospitals" value="true" <?php if ($_GET["showHospitals"] == "true") {
                    echo "checked";
                }  ?> >
                Show Schools:  <input type="checkbox" name="showSchools" id="showschools" value="true" <?php if ($_GET["showSchools"] == "true") {
                    echo "checked";
                }  ?> >
        ...
        <div class="eight columns" style="margin-top:3%">
            ...
            if ($displaying == true) {
                $url = "https://kaveenk.me/hth/innerdisplay.php?json=".$coordinates."&showHospitals=".$showHospitals."&showSchools=".$showSchools;
